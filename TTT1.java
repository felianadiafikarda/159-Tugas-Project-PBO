...
class TTT1 extends JFrame implements ItemListener, ActionListener{
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        if (c1.getState()) { // Memilih melawan komputer
            ...
            playerNameLabel1.setForeground(new Color(112, 128, 145));
            playerNameLabel1.setOpaque(true); // Buat label memiliki latar belakang yang dapat diwarnai
            playerNameLabel1.setBackground(new Color(245, 245, 245)); // Atur warna latar belakang menjadi putih
            playerNameLabel1.setBorder(new CompoundBorder(new LineBorder(new Color(245, 245, 245), 2), new EmptyBorder(5, 5, 5, 10))); // Atur panjang, lebar, dan warna border
            ...
            add(playerNameLabel1);
            playerNameLabel1.setBounds(120, 360, 150, 30);
            playerNameLabel1.setForeground(new Color(112, 128, 145));
            playerNameLabel1.setOpaque(true);
            playerNameLabel1.setBackground(new Color(245, 245, 245));
            playerNameLabel1.setBorder(new CompoundBorder(new LineBorder(new Color(245, 245, 245), 2), new EmptyBorder(5, 5, 5, 10))); // Atur panjang, lebar, dan warna border


            add(playerNameLabel2);
            playerNameLabel2.setBounds(120, 380, 150, 30);
            playerNameLabel2.setForeground(new Color(112, 128, 145));
            playerNameLabel2.setOpaque(true);
            playerNameLabel2.setBackground(new Color(245, 245, 245));
            playerNameLabel2.setBorder(new CompoundBorder(new LineBorder(new Color(245, 245, 245), 2), new EmptyBorder(5, 5, 5, 5))); // Atur panjang, lebar, dan warna border
        ...
        repaint(0, 0, 330, 450);
        showButton();
        reset.setBounds(110, 430, 100, 50);
    }
    /************************************************************/
